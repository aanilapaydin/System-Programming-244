...
#define SERVER2CLIENTFIFOPATTERN "/tmp/localServer.%lu"
#define FUNCTIONRESPONDPATTERN "/tmp/localServer.%u.%lu.txt"
 
#define TEMPSERVERLOGPATH "/tmp/localServerLog.txt"
#define TEMPCLIENTLOGPATH "/tmp/localServer.clientLog.%d.txt"
