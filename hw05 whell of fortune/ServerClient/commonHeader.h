...
#define SERVER2CLIENTFIFOPATTERN "/tmp/server.%lu"
#define FUNCTIONRESPONDPATTERN "/tmp/server.%u.%lu.txt"
 
#define TEMPSERVERLOGPATH "/tmp/serverLog.txt"
#define TEMPCLIENTLOGPATH "/tmp/server.clientLog.%d.txt"
